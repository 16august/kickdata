...
import { syncLeagues, syncTeams, syncFixtures, syncStandings } from "@/lib/isports/sync";
 ...
 *
 * Syncs leagues, teams, fixtures and standings. Players are NOT synced here — that makes
...
export async function GET(req: Request) {
  ...
  await step("standings", syncStandings);
